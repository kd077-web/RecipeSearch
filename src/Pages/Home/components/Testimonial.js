export const Testimonial = () => {
    return (
      <section className='my-20'>
          <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-5 underline underline-offset-8">Users About RecipeHub</h1>    
          <div className="grid mb-8 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-t-lg border-b border-gray-200 md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Savoring Culinary Perfection: A Recipe Hub Beyond Expectations</h3>
                      <p className="my-4 font-light">Discovering this website was a game-changer, offering diverse, delightful recipes for every occasion"</p>
                  </blockquote>
                  <figcaption className="flex justify-center items-center space-x-3">
                      ...
                      <div className="space-y-0.5 font-medium dark:text-white text-left">
                          ...
                          <div className="text-sm font-light text-gray-500 dark:text-gray-400">Student</div>
                      </div>
                  </figcaption>    
              </figure>
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-tr-lg border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Creative Gastronomy Unleashed: A Trusted Companion for Memorable Kitchen Adventures</h3>
                      <p className="my-4 font-light">From reliable classics to exciting experiments, this website is your go-to source for culinary inspiration</p>
                  </blockquote>
                  <figcaption className="flex justify-center items-center space-x-3">
              ...
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-bl-lg border-b border-gray-200 md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Satisfy Cravings, Nourish Well: A Culinary Playground for Tasty and Dietary Exploration</h3>
                      <p className="my-4 font-light">Delight in the fusion of flavors that not only taste good but align with various dietary needs, making every dish a wholesome experience</p>
                  </blockquote>
                  <figcaption className="flex justify-center items-center space-x-3">
                      ...
                      <div className="space-y-0.5 font-medium dark:text-white text-left">
                          <div>Jese Leos</div>
                          <div className="text-sm font-light text-gray-500 dark:text-gray-400">chef at Random</div>
                      </div>
                  </figcaption>    
              </figure>
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-b-lg border-gray-200 md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Taste and Wellness Harmony</h3>
                      <p className="my-4 font-light">eliciously mindful recipes that cater to varied tastes, promoting wellness through culinary creativity</p>
                  </blockquote>
                  <figcaption className="flex justify-center items-center space-x-3">
