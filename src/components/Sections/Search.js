...
export const Search = () => {
  ...
  const apiKey = 'fdf03d0ad2fb4c58bc68fd202da081eb'; // Replace with your Spoonacular API key
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        `https://api.spoonacular.com/recipes/findByIngredients?ingredients=${query}&query=13&apiKey=${apiKey}`
      );
